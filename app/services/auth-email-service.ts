  ...
  return `
    ...
    <html>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Welcome to tattootrace!</h1>
          </div>
          <div class="content">
            <h2>Hi ${name},</h2>
            <p>Thank you for signing up for tattootrace. To complete your registration and start using your account, please verify your email address.</p>
            ...
            <p>If you didn't create an account with tattootrace, you can safely ignore this email.</p>
            
            <p>Best regards,<br> from Vlad builder of Tattootrace</p>
          </div>
          <div class="footer">
            <p>&copy; ${new Date().getFullYear()} tattootrace. All rights reserved.</p>
            <p>Need help? Contact us at support@tattootrace.com</p>
          </div>
        </div>
      </body>
    </html>
    ...
    <html>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>Hi ${name},</h2>
            <p>We received a request to reset the password for your tattootrace account. If you made this request, click the button below to reset your password:</p>
            ...
            <p>Best regards,<br>The tattootrace Team</p>
          </div>
          <div class="footer">
            <p>&copy; ${new Date().getFullYear()} tattootrace. All rights reserved.</p>
            <p>Need help? Contact us at support@tattootrace.com</p>
